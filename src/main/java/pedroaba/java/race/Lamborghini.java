...
public class Lamborghini extends Car {
    ...
    public Lamborghini(Dispatcher<Object> dispatcher, int trackLength, Consumer<Object> consumer, PitStopScheduler pitStopScheduler) {
        super(Lamborghini.DEFAULT_SPEED, dispatcher, trackLength, consumer, pitStopScheduler);
    }
}
